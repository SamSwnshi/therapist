    ...
    <div className="flex flex-col min-h-screen overflow-hidden">
      <section className="relative min-h-[90vh] mt-10  flex flex-col items-center justify-center py-12 px-4">
        <div className="absolute inset-0 -z-10 overflow-hidden">
          ...
          />
          <div className="absolute w-[200px] h-[200px] rounded-md bg-purple-200 dark:bg-green-100 blur-3xl bottom-0 right-0 animate-pulse delay-900 duration-150" />
        ...
        <motion.div
          ...
          animate={{ opacity: mounted ? 2 : 0, y: mounted ? 0 : 30 }}
          transition={{ duration: 1, ease: "easeOut" }}
          className="relative space-y-8 text-center"
        >
          <div className="inline-flex items-center gap-2 rounded-full px-4 py-1.5 text-sm border border-primary/20 bg-primary/5 backdrop-blur-sm hover:border-green-300/40 transition-all duration-300">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold font-plus-jakarta tracking-tight">
            <span className="inline-block bg-gradient-to-r from-green-200 via-primary/90 to-green-700 bg-clip-text text-transparent [text-shadow:_0_1px_0_rgb(0_0_0_/_20%)] hover:to-green-200 transition-all duration-300">
              Find Peace
            </span>
            <br />
            <span className="inline-block mt-2 bg-gradient-to-b from-green-700 dark:from-green-100/90 to-green-300 dark:to-green-400/90  bg-clip-text text-transparent">
              of Mind
            </span>
          </h1>
          ...
          >
            <Button
              ...
              className="relative group h-12 px-8 rounded-full bg-gradient-to-r from-primary via-primary/90 to-secondary hover:to-primary shadow-lg shadow-green-200/20 transition-all duration-500 hover:shadow-xl hover:shadow-green-500/30"
            >
