...
// No interfaces; just document properties via comments if needed
...
export default function TherapyPage() {
    ...
    const [stressPrompt, setStressPrompt] = useState(null);
    ...
    const detectStressSignals = (message) => {
                                ...
                                >
                                    <div className="flex items-center gap-2 mb-1">
                                        ...
                                        <span className="font-medium">
                                            {(session.messages[0] && session.messages.content
                                                ? session.messages.content.slice(0, 30)
                                                : "New Chat")}
                                        </span>
                                    </div>
                                            ...
                                            <div className="flex gap-4">
                                                ...
                                                <div className="flex-1 space-y-2 overflow-hidden min-h-[2rem]">
                                                    <div className="flex items-center justify-between">
                                                        ...
                                                        {msg.metadata && msg.metadata.technique && (
                                                    ...
                                                    {msg.metadata && msg.metadata.goal && (
